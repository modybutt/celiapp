        ...
        const marginToUse = ((this.state.keyboardOpen) ? 300 : 0);
            ...
            return(
                <ScrollView style={{marginBottom: marginToUse}}>
                    ...
                    <SymptomGroup ref={component => this._symptomGroup = component} onSelectedSymptomIDsChanged={this.symptomSelectedIDsChangedHandler} selectedDate = {this.state.selectedDateAndTime}/>
