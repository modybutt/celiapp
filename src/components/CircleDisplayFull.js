...
export default class CircleDisplayFull extends React.Component {
  ...
  updateData() {
    ...
    console.log('m_dateStack :', JSON.stringify(m_dateStack));

    self.setState({ data: m_dateStack})
  }
      ...
      <View>
        ...
        {this.state && this.state.data &&
          ...
          <SymptomCircle colourInfoList={m_dateStack}
            ...
            maxNumberOfInnerDots={31}
            numberOfInnerDots={m_dateStack.length}
            titleText={"Day 10"}
          />
        }
      </View>
