...
export default class ReportInformation extends React.Component {
        ...
        return (
            <View style={
                ...
                <View style={[styles.subContainer, this.colorStyle]}>
                    ...
                    <Text style={styles.text}>In the weekly report screen you can see how well your are mastering it!</Text>
