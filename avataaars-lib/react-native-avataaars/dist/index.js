...
var Avatar = (function (_super) {
    ...
    Avatar.prototype.render = function () {
        ...
        var svgXml = ReactDOMServer.renderToString(React.createElement(AvatarReact, __assign({ style: {
                width: PixelRatio.getPixelSizeForLayoutSize(size),
                height: PixelRatio.getPixelSizeForLayoutSize(size)
            } }, this.props)));
        return (React.createElement(SvgXml, { xml: svgXml, width: size, height: size }));
    };
    return Avatar;
}(React.Component));
export { Avatar };
